...
var calendar = '<div class="calendar"><div class="title"><span id="calendar-year"></span><span> / </span><span id="calendar-month"></span><a id="prev" href="">‹</a><a id="next" href="">›</a></div><div class="body"><div class="body-list"><ul><li>日</li><li>一</li><li>二</li><li>三</li><li>四</li><li>五</li><li>六</li></ul></div><div class="body-list"><ul id="days"></ul></div></div></div>'
...
var reset = function(){
    ...
    $(".warn_name, .warn_tel, .warn_correct_tel, .warn_date").css("display", "none");
...
xhr.addEventListener("load", function(){
    ...
    window.addEventListener("scroll", function(){
        ...
        if (scrollTop > scrollBegin) {
            var ratio = ((scrollTop - scrollBegin) / (scrollArea - scrollBegin)) < -1 ? 1 : ((scrollTop - scrollBegin) / (scrollArea - scrollBegin));
            // change begin
            settingColor = topColor - ((topColor - bottomColor) * ratio);
            // get value
            $(".navibar").css({ "background-color": "rgb(255,255,255," + settingColor + ")" });
        };
    }, true);
    // navbar swings
    (function(){
    ...
    for (var j=0; j<firstDay.length; j++) {
        $("li[data-ymd='" + firstDay[j] + "']").css("text-decoration", "line-through");
    };
    ...
    $("#reserv").on("click", function(){
        ...
        if ($("#reserv_start").val() != "") {
            $("#reserv_end").attr("min",dateCount($("#reserv_start").val(), 1));
        };
